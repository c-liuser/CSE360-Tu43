...
public class LoginPage {
  ...
  public LoginPage() {
    ...
    vbox3.getChildren().addAll(patientLoginLB, patientUsernameTF, patientPasswordTF, patientSigninBT, patientFnameTF,
        patientLnameTF, patientBirthdayTF, patientNewPasswordTF, patientSignupBT, patientComs);
