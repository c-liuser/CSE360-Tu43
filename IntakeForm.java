...
public class IntakeForm {
	...
	public Scene IntakeFormFunction(Patient p) {
		...
		saveBtn.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent event) {
				...
				if (over12.isSelected()) {
					...
					Stage mainStage = (Stage) intakeFormScene.getWindow();
					mainStage.setScene(nView.getScene());
				}
		...
		intakeFormScene = new Scene(mainPane, 800, 600);
